...
class Linked(scrapy.Spider):
    ...
    def start_scraping (self,response):
    	...
    	lin = [
    	"https://www.linkedin.com/jobs/search?keywords=Java&location=Minneapolis%2C%20Minnesota%2C%20United%20States&geoId=103039849&trk=homepage-jobseeker_jobs-search-bar_search-submit&redirect=false&position=1&pageNum=0"]
  #   	nextpagelink = section.find('a', {'data-tracking-control-name': 'guest_job_search_create-job-alert-bottom-of-results'}
    ...
    def parse_memb(self,response):
    	...
    	next_page = "https://www.linkedin.com/jobs/search?keywords=Java&location=Minneapolis%2C%20Minnesota%2C%20United%20States&geoId=103039849&trk=homepage-jobseeker_jobs-search-bar_search-submit&redirect=false&position=1&pageNum="+str(Linked.page_numbers)
