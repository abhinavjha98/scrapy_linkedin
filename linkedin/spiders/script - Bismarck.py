...
class Linked(scrapy.Spider):
    ...
    def start_scraping (self,response):
    	...
    	lin = [
    	"https://www.linkedin.com/jobs/search?location=Bismarck%2C%2BNorth%2BDakota%2C%2BUnited%2BStates&geoId=102737163&trk=homepage-jobseeker_jobs-search-bar_search-submit&currentJobId=2016527023&position=3&pageNum=0"]
  #   	nextpagelink = section.find('a', {'data-tracking-control-name': 'guest_job_search_create-job-alert-bottom-of-results'}
    ...
    def parse_memb(self,response):
    	...
    	next_page = "https://www.linkedin.com/jobs/search?location=Bismarck%2C%2BNorth%2BDakota%2C%2BUnited%2BStates&geoId=102737163&trk=homepage-jobseeker_jobs-search-bar_search-submit&currentJobId=2016527023&position=3&pageNum="+str(Linked.page_numbers)
