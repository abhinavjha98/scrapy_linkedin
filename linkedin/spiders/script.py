...
class Linked(scrapy.Spider):
    ...
    def start_scraping (self,response):
    	return Request(url="https://www.linkedin.com/jobs/search/?geoId=90000512&location=Greater%20Minneapolis-St.%20Paul%20Area", callback=self.parse_memb)
    ...
    def parse_memb(self,response):
    	...
    	next_page = "https://www.linkedin.com/jobs/search/?geoId=90000512&location=Greater%20Minneapolis-St.%20Paul%20Area&start="+str(Linked.page_numbers)
    	print("Hello"+str(Linked.page_numbers))
    	if Linked.page_numbers<=5000:
    		Linked.page_numbers +=25
